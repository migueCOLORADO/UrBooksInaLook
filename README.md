...
Adicionalmente el sistema permitirá la creación de clubes de lectura, identificados por un código único, nombre, fecha de creación y estado (activo o inactivo). Para que un club de lectura pueda ser creado, al menos uno de sus miembros fundadores deberá tener registrado un ejemplar físico en su biblioteca personal dentro de la plataforma, garantizando así que el club esté vinculado a una colección real de libros. Los usuarios podrán participar en diferentes clubes, y cada club podrá seleccionar libros para ser leídos durante un periodo determinado, registrando la fecha en que cada libro fue seleccionado.
